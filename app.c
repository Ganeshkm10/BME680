...
SL_WEAK void app_process_action(void)
{
 ...
 delayApprox(3500000);
  ...
  i2c_init();
        //Reset
  i2c_write_reg(BME680_RESET_ADDR, 0x00);
  for(int i=0; i<80000; i++){
              __asm("nop");
          }

        // Set humidity oversampling to x1
//        i2c_write_reg(BME680_CTRL_HUM_ADDR, 0x01);
////        for(int i=0; i<30000; i++){
////            __asm("nop");
////        }
//        // Set temperature, pressure, and gas oversampling to x1
//        i2c_write_reg(BME680_CTRL_MEAS_ADDR, 0x25);
////        for(int i=0; i<30000; i++){
////                   __asm("nop");
////               }
//////
//////        // Set sensor to sleep mode
//        i2c_write_reg(BME680_CONFIG_ADDR, 0x00);
////        for(int i=0; i<80000; i++){
////                   __asm("nop");
////               }
        ...
        int16_t humidity = read_humidity();
